...
class DataManager:
    ...
    def create(self):       
        ...
        self.cursor.execute('CREATE TABLE transObj(ArtNo INTEGER PRIMARY KEY, Bezeichnung VARCHAR, Laenge FLOAT, Breite FLOAT, Hoehe FLOAT, Gewicht FLOAT, VerpackId INTEGER, VerpackStueck INTEGER)')
