...
class DataManager:
    ...
    # creating of tables and resding of data
    def create(self):       
    ...
    # takes list of artikel-ids and returns list of artikel tuples
    ...
    # takes list of tranobjs-ids and returns list of artikel tuples
...
try:
    ...
    print(Manager.getTransObjs[1:5])
